...
.. XML source: https://github.com/geqo-godot/geqo/tree/master/doc_classes/EnvironmentQuery3D.xml.

.. _class_EnvironmentQuery3D:
...
A node used to gather environment data using a :ref:`QueryGenerator3D<class_QueryGenerator3D>` and evaluating them using :ref:`QueryTest3D<class_QueryTest3D>`\ s.
...
**EnvironmentQuery3D** provides a flexible, node-based system for AI agents to ask spatial questions about the environment. Queries are composed by adding one :ref:`QueryGenerator3D<class_QueryGenerator3D>` as child of the environment query and assigning :ref:`QueryTest3D<class_QueryTest3D>`\ s as children of the :ref:`QueryGenerator3D<class_QueryGenerator3D>`.
...
.. _class_EnvironmentQuery3D_signal_query_finished:
...
``float`` **time_budget_ms** = ``1.0`` :ref:`🔗<class_EnvironmentQuery3D_property_time_budget_ms>`
...
.. _class_EnvironmentQuery3D_property_use_debug_shapes:

.. rst-class:: classref-property

``bool`` **use_debug_shapes** = ``false`` :ref:`🔗<class_EnvironmentQuery3D_property_use_debug_shapes>`
...
If ``true`` creates debug visuals in the environment, showing each :ref:`QueryItem3D<class_QueryItem3D>`.
...
.. _class_EnvironmentQuery3D_method_request_query:
